  ...
  return (
    <Box sx={{ p: 3, maxHeight: "calc(100vh - 64px)", overflowY: "auto" }}>
      ...
      <Typography>
        ...
        Students must be either on campus connected to <strong>eduroam</strong>{" "}
      ...
      <Typography>
        ...
        Students must connect to any queue that has a desired printer. There are
        3 print queues for students to use on campus:
      </Typography>
      <List component="ol">
      ...
      <Typography>
        These directions were taken from the EIT knowledge base. For any issues
        in this section please contact EIT.
      </Typography>
      <List sx={{ "--_List-markerType": "decimal", pl: 4 }}>
        <ListItem sx={{ display: "list-item" }}>
          From your desktop, move your cursor to the lower left-hand corner of
          the screen and click on “<strong>Show Applications</strong>” (Icon
          with nine dots).
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
          A list of your applications should appear. Find the icon labeled “
          <strong>Terminal</strong>” or type “<strong>Terminal</strong>” into
          the search bar and press the enter key on your keyboard.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
        ...
        <ListItem sx={{ display: "list-item" }}>
          ...
          down until you find the setting labeled “<strong>Printers</strong>”
          and click on it.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
        ...
        <ListItem sx={{ display: "list-item" }}>
          ...
          list click the drop-down menu labeled “
          <strong>Network Printer</strong>” and click on “
          <strong>Windows Printer via SAMBA</strong>”.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
          In the field labeled <strong>smb://</strong> type the following
          network address in: <strong>print.rose-hulman.edu/</strong>. (Please
          note: Make sure the forward slash is present, or you will get an
          error). Once you enter the network address, click the button next to
          the field labeled “<strong>Browse</strong>”.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
          ...
          account password into the password field. Click the “
          <strong>OK</strong>” button or press the enter key when finished.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
          ...
          <strong>RHIT Library Color Printing</strong>. Click on the name that
          is necessary to you and click “<strong>OK</strong>”.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
        ...
        <ListItem sx={{ display: "list-item" }}>
          In the “<strong>Password</strong>” field, input your Rose-Hulman
          account password. In the “<strong>Username</strong>” field type the
          following: <strong>rose-hulman.edu\username</strong>. (Note: Replace{" "}
          <strong>username</strong> with your Rose Hulman username). Once you
          are finished, click <strong>Forward</strong>.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
        ...
        <ListItem sx={{ display: "list-item" }}>
          ...
          put whatever will help you distinguish the two print queues apart.
          Once you are finished, click the button labeled “
          <strong>Apply</strong>”.
        </ListItem>
      </List>
      <Typography>&nbsp;</Typography>
      ...
      <List sx={{ "--_List-markerType": "decimal", pl: 4 }}>
        ...
        <ListItem sx={{ display: "list-item" }}>
          Choose the option “<strong>System Settings</strong>” from the
          drop-down menu.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
          A window should appear with multiple options on the left side. Move
          your cursor to the left side and scroll down until you find “
        ...
        <ListItem sx={{ display: "list-item" }}>
          A window should appear with a list of printers to connect to. If you
          do not see a list, move your cursor to the top of the window and
          choose the first option on the left labeled “<strong>Default</strong>
          ”.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
          The following two printers should appear: “
          <strong>rhit bw printing</strong>” and “
          <strong>rhit library color printing</strong>”. Click on what you
          require and go to the lower right-hand corner of the window and click
          “<strong>Add</strong>”.
        </ListItem>
      </List>
      <Typography>&nbsp;</Typography>
      ...
      <List sx={{ "--_List-markerType": "decimal", pl: 4 }}>
        <ListItem sx={{ display: "list-item" }}>
          ...
          key and the <strong>P</strong> key at the same time to open the
          printing menu.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
      ...
      <List sx={{ "--_List-markerType": "decimal", pl: 4 }}>
        ...
        <ListItem sx={{ display: "list-item" }}>
          ...
          “<strong>Name</strong>” you will need to input your Rose-Hulman
          username. In the password field, you will enter Rose-Hulman account
          password. Then, click OK or press the “<strong>Return</strong>” key on
          your keyboard. (Note: you can click on “
      ...
      <List sx={{ "--_List-markerType": "decimal", pl: 4 }}>
        <ListItem sx={{ display: "list-item" }}>
          Use the printer list or search bar to find the printer you want to
          print to.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
          The name of the printer you selected should now appear at the top of
          the screen. All of your current print jobs will be listed. Note that a
          printer will only show the print jobs on its associated print queue.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
          Click on the "<strong>Show map</strong>" button to see where the
          printer is located. Verify the location of the printer you selected.
        </ListItem>
      </List>
      ...
      <List sx={{ "--_List-markerType": "decimal", pl: 4 }}>
        ...
        <ListItem sx={{ display: "list-item" }}>
          Click "<strong>Refresh Queue</strong>" to verify that the print job
          was released.
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
